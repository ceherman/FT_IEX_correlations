...
def get_Keq_nd(surf_area, porosity, keq_dim):
    """Convert dimensional Keq [m] into dimensionless Keq"""
    keq_nd = surf_area/(1.0 - porosity) * keq_dim
    return keq_nd

def get_kprime(surf_area, porosity, keq_dim):
    """Convert dimensional Keq [m] into k' """
    keq_nd = get_Keq_nd(surf_area, porosity, keq_dim)
    kprime = (1.0 - porosity)/porosity * keq_nd
    return kprime
